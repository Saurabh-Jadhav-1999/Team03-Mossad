...
//     const allHotelsList = filteredHotels.map((item) => (<HotelDetailsCard key={item.hotel_id} details={item} />));
//     setDisplayList(allHotelsList);
...
//         }
//         (filteredHotels.length > 3 ? setViewAll(true) : setViewAll(false))
//       })

//       setDisplayList(firstThree)
//     }
//     else {
//       const allHotelsList = hotelList.map((item) => (<HotelDetailsCard key={item.hotel_id} details={item} />));
//       setDisplayList(allHotelsList);
//     }
